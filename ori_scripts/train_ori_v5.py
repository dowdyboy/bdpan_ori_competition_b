...
parser.add_argument('--scale-size', nargs='+', type=int, default=[520], help='input img size')
parser.add_argument('--img-size', nargs='+', type=int, default=[512], help='input img size')
