...
class SqueezeNet(nn.Layer):
    ...
    def __init__(self, version, divide=1, num_classes=1000, with_pool=True):
        ...
        if self.version == "1.0":
            ...
            self._conv1 = MakeFire(96, 16, 64 // divide, 64 // divide)
            self._conv2 = MakeFire(128 // divide, 16, 64 // divide, 64 // divide)
            self._conv3 = MakeFire(128 // divide, 32, 128 // divide, 128 // divide)
            self._conv4 = MakeFire(256 // divide, 32, 128 // divide, 128 // divide)
            self._conv5 = MakeFire(256 // divide, 48, 192 // divide, 192 // divide)
            self._conv6 = MakeFire(384 // divide, 48, 192 // divide, 192 // divide)
            self._conv7 = MakeFire(384 // divide, 64, 256 // divide, 256 // divide)
            self._conv8 = MakeFire(512 // divide, 64, 256 // divide, 256 // divide)
        else:
            self._conv = Conv2D(
                3,
                64,
            ...
            self._conv1 = MakeFire(64, 16, 64 // divide, 64 // divide)
            self._conv2 = MakeFire(128 // divide, 16, 64 // divide, 64 // divide)
            self._conv3 = MakeFire(128 // divide, 32, 128 // divide, 128 // divide)
            self._conv4 = MakeFire(256 // divide, 32, 128 // divide, 128 // divide)
            self._conv5 = MakeFire(256 // divide, 48, 192 // divide, 192 // divide)
        ...
        self._conv9 = Conv2D(
            512 // divide, num_classes, 1, weight_attr=ParamAttr(), bias_attr=ParamAttr())
