...
def build_data():
    # batch size 可能影响速度？
    test_dataset = OriTestDataset(src_image_dir, scale_size=520, img_size=512)
...
def process():
    ...
    # chk_dir = 'checkpoint/ori/0902/v6_fp_epoch_1638/model_0.pd'
    # chk_dir = 'checkpoint/ori/0904/v6_epoch_1392/model_0.pd'
    chk_dir = 'checkpoint/best_epoch_1392.pd'
    model = build_model()
